...
const founderContent = `import type { Metadata } from "next";
...
fs.writeFileSync('c:/Users/hirip/Desktop/ProjectsEassylife/arthajuris/app/founder/page.tsx', founderContent, 'utf8');

const mayuraMarkdown = `# Profile: Advocate Mayura Navnit Maru

Advocate Mayura Navnit Maru is a senior legal practitioner based in Mumbai, with over 25 years of independent practice before the Bombay High Court and various courts/tribunals across Pan India. An accomplished professional with a proven ability to represent clients in complex and challenging environments, she brings exceptional litigation strategy, client advocacy, and meticulous case management to the table.

Enrolled with the Bar Council of Maharashtra & Goa in 2002, she is proficient in English, Hindi, Gujarati, and Marathi.

## Core Practice Areas
- **Corporate & Commercial Law** – Corporate matters, business contracts, arbitration, winding up petitions before NCLT, IBC proceedings, DRT/DRAT proceedings, corporate governance compliance.
- **Real Estate & Property Law** – Title search reports, residential property transfers, RERA, CIDCO, MIDC matters, redevelopment projects, SRA, MLRC, Tenancy Act, Land Laws, contract preparation, commercial leases, review of loan documents, MOFA and MRTP Act disputes.
- **Civil Litigation** – Consumer Forum cases, banking litigation, recovery of money suits, motor accident claims, medical negligence, defamation suits, testamentary matters (Probate, Letters of Administration, Succession).
- **Family Law** – Divorce, matrimonial disputes, domestic violence matters, child custody, maintenance, property-related family disputes.
- **Banking & Finance** – Debt recovery, banking tribunal matters, SARFAESI Act proceedings, NPA resolution, loan documentation review and vetting.

## Professional Experience Timeline
- **Freelance Lawyer | Self Employed** (2007 – Present)
- **Associate Advocate | D. M. Harish & Co. Advocates** (2005 – 2007)
- **Associate Advocate | Little & Co. Advocates and Solicitors** (2003 – 2005)
- **Legal Assistant | Mahimtura and Co. Advocates and Solicitors** (2002 – 2003)
- **Legal Assistant | Kantawala & Co. Advocates and Solicitors** (2001 – 2002)

## Courts of Practice
- Bombay High Court (Appellate & Original Side)
- National Company Law Tribunal (NCLT)
- Debts Recovery Tribunal (DRT) & DRAT, Mumbai
- Consumer Forum & Civil Courts
- Family Courts, Mumbai
- District Courts in Mumbai, Raigad, Panvel, Thane, Alibaug, Khopoli
- Criminal Courts across Maharashtra
...
fs.writeFileSync('c:/Users/hirip/Desktop/ProjectsEassylife/arthajuris/profiles/Adv_Mayura_Maru.md', mayuraMarkdown, 'utf8');

console.log('Successfully updated Founder page and markdown');
