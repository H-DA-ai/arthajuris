...
const pratapContent = `import type { Metadata } from "next";
...
const uzmaContent = `import type { Metadata } from "next";
import Link from "next/link";
import Image from "next/image";
...
fs.mkdirSync('c:/Users/hirip/Desktop/ProjectsEassylife/arthajuris/app/pratap-temgire', { recursive: true });
fs.writeFileSync('c:/Users/hirip/Desktop/ProjectsEassylife/arthajuris/app/pratap-temgire/page.tsx', pratapContent, 'utf8');

fs.mkdirSync('c:/Users/hirip/Desktop/ProjectsEassylife/arthajuris/app/uzma-khan', { recursive: true });
fs.writeFileSync('c:/Users/hirip/Desktop/ProjectsEassylife/arthajuris/app/uzma-khan/page.tsx', uzmaContent, 'utf8');

console.log('Successfully created junior pages');
